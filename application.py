...
rounded_error_rates_dtc = [round(num, 2) for num in error_rates_dtc]
print("Error Rates (Rounded):", rounded_error_rates_dtc)
...
plt.figure(figsize=(10,6))
plt.plot(range(1, 21))
plt.plot(range(1, 21), rounded_error_rates_dtc, marker='^', label='Error Rates', color='red', linestyle='solid')
plt.title('Performance Metrics vs Max Depth')
plt.xlabel('Max Depth')
plt.ylabel('Performance Metrics')
plt.legend()
...
rounded_error_rate_svm = [round(num, 2) for num in error_rate_svm]
print("Error Rate (Rounded):",rounded_error_rate_svm)
...
def lr():
    ...
    render_template(
        ...
        rounded_error_rate_lr = rounded_error_rate_lr,
...
def svm():
    ...
    return render_template(
        ...
        rounded_error_rate_svm = rounded_error_rate_svm,
